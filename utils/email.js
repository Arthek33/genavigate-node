...
module.exports = class Email {
  ...
  async send(template, subject) {
    ...
    //   },
    // );
    const html = `<div><div>${subject}</div><div>Hello ${this.firstName}.</div><div><a href="${this.url}" target="_blank">Button</a></div></div>`;
  ...
  async sendWelcome() {
    await this.send('welcome', 'Welcome to the Genavigate Family!');
  }
